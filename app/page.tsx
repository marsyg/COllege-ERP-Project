  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <header className="bg-[#0c4da2] text-white py-4 px-6 shadow-md">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center mb-4 md:mb-0">
            ...
            <h1 className="text-xl font-bold">Bhagwan Parshuram Institute of Technology</h1>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              <h2 className="text-4xl font-bold mb-4">Welcome to BPIT</h2>
              <p className="text-xl mb-6">
                Empowering students with quality education and innovative learning experiences since 1999.
              </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-center mb-12">Why Choose BPIT?</h2>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-gray-600">Consistently ranked among the top engineering colleges in Delhi NCR.</p>
                </div>
              </CardContent>
            </Card>
      ...
      <section className="bg-blue-800 text-white py-12">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-6 max-w-2xl mx-auto">
            Join BPIT and take the first step towards a successful career in engineering and technology.
          </p>
          <Link href="/student-registration">
      ...
      <footer className="bg-gray-900 text-white py-8">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">About BPIT</h3>
              <p className="text-gray-400">
                Bhagwan Parshuram Institute of Technology was established in 1999 and is affiliated to GGSIPU.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <address className="text-gray-400 not-italic">
                ...
                <br />
                <a href="tel:+911127582095" className="hover:text-white">
                  +91-11-27582095
                </a>
                <br />
                <a href="mailto:info@bpitindia.com" className="hover:text-white">
                  info@bpitindia.com
                </a>
              </address>
            </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-6 text-center text-gray-400">
            <p>© {new Date().getFullYear()} Bhagwan Parshuram Institute of Technology. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
